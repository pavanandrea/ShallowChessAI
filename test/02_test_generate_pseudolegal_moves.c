...
//
//  How to run:
//  gcc 02_test_generate_pseudolegal_moves.c -o 02_test_generate_pseudolegal_moves -std=c17 -Wall -Wextra
...
int main() {
    ...
    generate_pseudolegal_moves(&movelist, &gameboard);
    if (movelist.NMOVES==9) {
    ...
    generate_pseudolegal_moves(&movelist, &gameboard);
    if (movelist.NMOVES==8+10+6+4+0+2) {
